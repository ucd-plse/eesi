...
void bugs(Module &Mod, string specs_path, string error_only_path);
...
int main(int argc, char **argv) {
  ...
  if (command == "specs") {
    ...
    bugs(*Mod, specs_path, error_only_path);
...
void bugs(Module &Mod, string specs_path, string error_only_path) {
  ...
  ReturnPropagationPointer *return_propagation = new ReturnPropagationPointer;
  ReturnConstraintsPointer *return_constraints = new ReturnConstraintsPointer;
  MissingChecks *missing_checks = new MissingChecks(specs_path, error_only_path);
